      ...
      <div className="mx-auto grid max-w-6xl items-center gap-14 lg:grid-cols-2">
        ...
        <Reveal delay={0.15}>
          ...
          <h2 className="mb-5 text-4xl font-bold tracking-tight text-ink sm:text-5xl md:text-6xl dark:text-white">
            Punkty za każdą wizytę.
          </h2>
          <p className="mb-8 max-w-lg text-lg leading-relaxed text-neutral-500 sm:text-xl dark:text-neutral-400">
            Zrealizowane wizyty to punkty, ligi i miesięczny ranking. Rywalizuj od Brązu po
            Diament — a Twoja prywatność jest chroniona domyślnie: inni widzą Cię z zamaskowanym
            imieniem i bez zdjęcia, dopóki sam nie zdecydujesz inaczej.
          </p>
          <ul className="space-y-3 text-[15px] text-neutral-600 dark:text-neutral-300">
            {[
              'Punkty naliczają się same po każdej wizycie',
              'Ligi: Brąz, Srebro, Złoto, Platyna, Diament',
              'Prywatność wbudowana — widoczność kontrolujesz Ty',
            ].map((item) => (
              <li key={item} className="flex items-start gap-3">
                <span className="mt-[7px] h-2 w-2 shrink-0 rounded-full bg-accent" />
                {item}
